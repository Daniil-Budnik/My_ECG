...
// Формат предоставляет чтение однобайтовых данных в одном или двух
// канальном режиме, диапазон чисел варируется от 0 до 240,
// остальные числа являются зарезервированными для команд.

// --- Зарезервированные байты (шестнадцатеричный вид) ---

// FA - Включен только канал 1
// FB - Включен только канал 2
// FC - Включены все каналы
// FD - Оставка
// FF - Проверка порядка

// Они должы прийти попарно, чтобы исключить ошибку ложной команды
// (пример: FFFF, FAFA и.т.д)

// По мимо этого, формат подразумевает обоюдное чтение команд
// (отправку команд как на сервер, так и на клиент)

// В ЗАПАСЕ ЕЩЕ КОДЫ С F1 до F9 ДЛЯ ДОПОЛНИТЕЛЬНЫХ КОМАНД
